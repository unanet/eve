...
IMAGE_NAME := unanet-docker-int.jfrog.io/ops/eve-api-v1
...
docker-scanner-exec = docker run --rm \
	...
	sonarsource/sonar-scanner-cli sonar-scanner -Dsonar.projectKey=eve -Dsonar.exclusions=**/*_test.go,**/*mock*.go
